...
# Renombramos las variables de cada DataSet y definimos la variable "superv" 
# de tipo factor.
...
Ninguno de los contrastes proporciona un p valor inferior a $0.05$, por lo que en ningún caso podemos rechazar la hipótesis nula de que las medias, para cada característica, no sean las mismas, y aceptamos la hipotesi nula, que las medias son iguales.
...
Entonces, dado que el _p-valor_ es inferior a 0.05 rechazamos la hipotesi nula, a favor de la hipotesi alternativa, que las covarianzas son diferentes.